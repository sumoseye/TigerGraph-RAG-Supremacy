...
Be specific, cite paper titles and authors when relevant, and provide insights."""
...
Based on the papers in this dataset, provide a detailed answer:"""
        ...
        print(f"✅ {response.usage.total_tokens} tokens in {latency_ms:.0f}ms\n")
